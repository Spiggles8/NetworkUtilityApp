...
internal static class MacVendors
{
  ...
  // Returns "Unknown" when no match is found, or empty string when input is clearly invalid.
  ...
  // Tolerant: if the file is missing or unreadable, return an empty dictionary
  // so callers will get "Unknown" for all lookups instead of failing.
